...
namespace Providence.Content.Items.BossSpawners
{
	public class ScintillatingObsidian : ModItem
	{
		...
		{
			Texture2D texture = Request<Texture2D>("Providence/Content/Items/BossSpawners/ScintillatingObsidianAnimated").Value;
		...
		{
			Texture2D texture = Request<Texture2D>("Providence/Content/Items/BossSpawners/ScintillatingObsidianGlow").Value;
