...
{
	public class CyanCoralBlock : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Cyan Coral"); // Sets the map hover name
			...
			ItemDrop = ModContent.ItemType<Providence.Content.Items.Placeables.Brinewastes.CyanCoralBlock>(); // The item to drop when this tile is mined or broken
