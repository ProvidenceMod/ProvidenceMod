...
using static Providence.PrimitiveTrails.Trail;

namespace Providence.PrimitiveTrails
{
	// Code by Boffin (From Spirit Mod)
	public class TrailHelper : ModSystem
	{
		...
		{
			ProvidenceMod.Trails = this;
			trails = new Dictionary<ITrailObject, Trail>();
			effect = ModContent.Request<Effect>("Providence/Assets/Effects/trailShaders", AssetRequestMode.ImmediateLoad).Value;
		...
		public void UpdateTrails()
		{
			...
			{
				KeyValuePair<ITrailObject, Trail> trail = trails.ElementAt(i);
		...
		{
			ProvidenceMod.Trails.TryEndTrail(trail);
		}
		...
		public override void PreUpdateProjectiles()
		{
			if (Main.netMode != NetmodeID.Server)
				ProvidenceMod.Trails.UpdateTrails();
		}
	...
	public class DefaultTrailPosition : ITrailPosition
	{
		...
		{
			ProvidenceMod.Trails.trails.TryGetValue(trailObject, out Trail trail);
