...
namespace UnbiddenMod.Items.Consumables
{
  public class ScintilatingObsidian : ModItem
  {
    ...
    public override void PostDrawInInventory(
      ...
      Color itemColor,
      Vector2 origin,
      float scale) => item.DrawGlowmask(spriteBatch, GetTexture("UnbiddenMod/Items/Consumables/ScintilatingObsidianGlow"), 13, default, scale, new Vector2(0f, -13f), true);
    public override void PostDrawInWorld(
      ...
      Color lightColor,
       ...
       float rotation,
       float scale,
       int whoAmI) => item.DrawGlowmask(spriteBatch, GetTexture("UnbiddenMod/Items/Consumables/ScintilatingObsidianGlow"), 13, default, scale, new Vector2(0f, -13f), true);
