...
namespace ProvidenceMod.Prefixes
{
  public class ElementalPrefix : ModPrefix
  {
    ...
    public override bool Autoload(ref string name)
    {
      ...
      mod.AddPrefix("Searing", new ElementalPrefix(20, ElementID.Fire));
      mod.AddPrefix("Scorching", new ElementalPrefix(30, ElementID.Fire));

      mod.AddPrefix("Chilling", new ElementalPrefix(10, ElementID.Ice));
      mod.AddPrefix("Freezing", new ElementalPrefix(20, ElementID.Ice));
      mod.AddPrefix("Frostbiting", new ElementalPrefix(30, ElementID.Ice));
      ...
      mod.AddPrefix("Electrocuting", new ElementalPrefix(30, ElementID.Lightning));
      ...
      mod.AddPrefix("Crushing", new ElementalPrefix(20, ElementID.Earth));
      mod.AddPrefix("Shattering", new ElementalPrefix(30, ElementID.Earth));

      mod.AddPrefix("Breezy", new ElementalPrefix(10, ElementID.Air));
      mod.AddPrefix("Gale-Force", new ElementalPrefix(20, ElementID.Air));
      mod.AddPrefix("Tempestuous", new ElementalPrefix(30, ElementID.Air));
