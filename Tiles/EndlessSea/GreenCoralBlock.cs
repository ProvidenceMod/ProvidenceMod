...
{
	public class GreenCoralBlock : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Green Coral"); // Sets the map hover name
			AddMapEntry(new Color(69, 243, 104), name); // Adds the map entry for this tile with a hover name
			dustType = DustID.Platinum; // TODO: Make a dedicated dust for this tile // The type of dust to create when hit
			drop = ModContent.ItemType<Items.Placeable.EndlessSea.GreenCoralBlock>(); // The item to drop when this tile is mined or broken
