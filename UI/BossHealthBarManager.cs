...
namespace ProvidenceMod.UI
{
	public static class BossHealthBarManager
	{
		...
		public static void Initialize()
		{
			...
			frameTexture = GetTexture("ProvidenceMod/ExtraTextures/UI/BossFrame");
			healthTexture = GetTexture("ProvidenceMod/ExtraTextures/UI/BossHP");
			comboTexture = GetTexture("ProvidenceMod/ExtraTextures/UI/BossCombo");
			shadowLeftTexture = GetTexture("ProvidenceMod/ExtraTextures/UI/BossShadowL");
			shadowRightTexture = GetTexture("ProvidenceMod/ExtraTextures/UI/BossShadowR");
			shadowMiddleTexture = GetTexture("ProvidenceMod/ExtraTextures/UI/BossShadowF");
			shadowComboTexture = GetTexture("ProvidenceMod/ExtraTextures/UI/BossShadowC");
			underlineTexture = GetTexture("ProvidenceMod/ExtraTextures/UI/BossUnderline");
			bloomTexture = GetTexture("ProvidenceMod/ExtraTextures/UI/BossBloom");
		}
		...
		public static void DrawMainHealthBar()
		{
			...
			if (!shouldFadeOut1)
			{
				...
				if (ProvidenceMod.Instance.bossPercentage)
				{
					...
					DrawBorderStringEightWay(spriteBatch, ProvidenceMod.bossHealthFont ?? Main.fontItemStack, text, new Vector2(anchor.X + 970f - vPercent.X, anchor.Y - 2), new Color((int)(200 * opacity1), (int)(200 * opacity1), (int)(200 * opacity1), (int)(255 * opacity1)), new Color((int)(23 * opacity1), (int)(23 * opacity1), (int)(23 * opacity1), (int)(255 * opacity1)), 0.8f);
				}
				...
				if (ProvidenceMod.Instance.bossHP)
				{
					...
					DrawBorderStringEightWay(spriteBatch, ProvidenceMod.bossHealthFont ?? Main.fontItemStack, $"{npcs[0]?.life} / {npcs[0]?.lifeMax}", new Vector2(anchor.X + 50f, anchor.Y + 3f), new Color((int)(220 * opacity1), (int)(220 * opacity1), (int)(220 * opacity1), (int)(255 * opacity1)), new Color((int)(23 * opacity1), (int)(23 * opacity1), (int)(23 * opacity1), (int)(255 * opacity1)), 0.5f);
				}

				DrawBorderStringEightWay(spriteBatch, ProvidenceMod.bossHealthFont ?? Main.fontItemStack, npcs[0] != null ? npcs[0].FullName : "", new Vector2(anchor.X + 500f - (vTitle.X * 0.75f * 0.5f), anchor.Y + 50), new Color((int)(200 * opacity1), (int)(200 * opacity1), (int)(200 * opacity1), (int)(255 * opacity1)), new Color((int)(23 * opacity1), (int)(23 * opacity1), (int)(23 * opacity1), (int)(255 * opacity1)), 0.75f);
				DrawBorderStringEightWay(spriteBatch, ProvidenceMod.bossHealthFont ?? Main.fontItemStack, npcs[0] != null ? npcs[0].Providence().GetBossTitle(npcs[0]?.FullName) : "", new Vector2(anchor.X + 500f - (vName.X * 0.40f * 0.5f), anchor.Y + 5), new Color((int)(220 * opacity1), (int)(220 * opacity1), (int)(220 * opacity1), (int)(255 * opacity1)), new Color((int)(23 * opacity1), (int)(23 * opacity1), (int)(23 * opacity1), (int)(255 * opacity1)), 0.40f);
