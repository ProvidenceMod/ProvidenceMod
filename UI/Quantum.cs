...
namespace ProvidenceMod.UI
{
	internal class Quantum : UIElement
	{
		...
		public override void OnInitialize()
		{
			...
			QuantumFrame = GetTexture("ProvidenceMod/ExtraTextures/UI/QuantumFrame");

			QuantumUseRect = new Rectangle(0, 0, 0, 24);
			QuantumUse = GetTexture("ProvidenceMod/ExtraTextures/UI/QuantumUse");

			QuantumBarRect = new Rectangle(0, 0, 0, 24);
			QuantumBar = GetTexture("ProvidenceMod/ExtraTextures/UI/QuantumBar");

			QuantumLightningRect = new Rectangle(0, 0, 0, 22);
			QuantumLightning = GetTexture("ProvidenceMod/ExtraTextures/UI/QuantumLightning");
